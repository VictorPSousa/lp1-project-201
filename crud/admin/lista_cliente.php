...
<body>
        ...
        <?php
            ...
            echo'<div id="container">';
                 ...
                 echo '<br/><b>Telefone: </b>'.$linha['telefone'].' <b>Celular: </b>'.$linha['celular'].'<br/>';   
                 ...
                 echo '<a href="form_editar_cliente.php?id='.$linha['id'].'"><button class="button">Editar</button></a>';
                 echo '<a href="excluir_cliente.php?id='.$linha['id'].'"><button class="button">Excluir</button></a>';
                 echo '</div><br/><hr/></div>';
            echo '</div>';
            }
        ?>
